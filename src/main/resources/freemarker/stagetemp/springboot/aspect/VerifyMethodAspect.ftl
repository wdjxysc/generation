package ${packgeName}.framework.aspect;
...
public class VerifyMethodAspect {
	 ...
	 * 	Verify注解包路径
	 */
	public static String VERIFY_PACKAGE = "${packgeName}.framework.verify.annotation.Verify";
	/**
	 * 	DataMessage包路径，用于返回封装的json消息
	 */
	public static String DATAMESSAGE_PACKAGE = "${packgeName}.framework.config.ResponseModel";
	/**
	 * 	String包路径
	 */
	 ...
	 * @throws
	 */
	@Around("@annotation(${packgeName}.framework.annotation.ApiParamsVerify)")
    public Object around(ProceedingJoinPoint point) {
	    ...
	    ApiParamsVerify apiParamsVerify = currentMethod.getAnnotation(${packgeName}.framework.annotation.ApiParamsVerify.class);
            ...
            for(int i = 0;i < argsLength;i++) {
        		...
        		for(Annotation aItem : annotations) {
        			...
        			if(VERIFY_PACKAGE.equals(aItem.annotationType().getName())) {
        				...
        				${packgeName}.framework.verify.annotation.Verify v = (Verify)aItem;
