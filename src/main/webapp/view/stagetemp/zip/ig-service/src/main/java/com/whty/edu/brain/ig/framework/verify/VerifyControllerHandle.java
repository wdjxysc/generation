...
import com.whty.edu.brain.ig.framework.config.SpringContextHolder;
...
import com.whty.edu.brain.ig.framework.verify.annotation.VerifyType;

/**   
 * @formatClassName:  VerifyControllerHandle
 * @Description:TODO controller接口参数校验通用校验入口
 * @author: generation
 * @date:   2020年04月17日 09:28:359
...
public class VerifyControllerHandle {
	...
	public List<String> verify(com.whty.edu.brain.ig.framework.verify.annotation.Verify verify, Object param, boolean collect) throws CommonDefineException {
		try {
			...
			for (Field f : fields) {
				...
				for (Annotation annotation : annotations) {
					...
					try {
						...
						logger.info("annotationVerify:当前注解指定的校验实现类【{}】需继承com.whty.edu.brain.ig.framework.verify.VerifyHandle，实现verify方法", handleClass);
						continue;
					}
